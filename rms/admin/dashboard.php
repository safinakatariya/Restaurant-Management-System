...
<div class="section white-text center" style="background:  #00000093; margin-top: 20px;">
	...
	<div class="row" style="padding: 50px;">
		<div class="col s12">
			...
			<a class="dash-btn" href="food-list.php"><div class="sec white white-text" style="margin: 15px; padding: 40px;border: 2px solid white; border-radius: 20px; font-size: 20px; background: linear-gradient(to right, #00000093, #000);">Foods</div></a>
